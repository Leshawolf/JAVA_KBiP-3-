...
class ListWork extends JFrame{
    ...
    public ListWork(String s){
        ...
        myHash.put("Бяроско Даниил","Пушкина, +375291113244245");
        myHash.put("Волчек Алексей","Калатушкино, +37529245325263");
        myHash.put("Паряфянович Александр","Притыцкого, +375291245325245");
